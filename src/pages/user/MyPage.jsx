        ...
        <div className="max-w-screen-xl mx-auto">
          ...
          <div className=" bg-[#f1f1f1] py-12 max-[500px]:py-8 flex items-center gap-x-40 max-[1000px]:gap-x-20 max-[700px]:gap-x-10 justify-center relative max-[500px]:flex-col max-[500px]:gap-y-7">
            ...
            <div className="flex items-center pb-4">
              <div className="text-base max-[700px]:text-sm border-x border-[#ccc] px-20 max-[900px]:px-14 max-[700px]:px-10 py-3 shrink-0 max-[500px]:border-x-0 max-[500px]:border-r">
                주문
              ...
              <div className="text-base max-[700px]:text-sm border-r border-[#ccc] px-20 max-[900px]:px-14 max-[700px]:px-10 py-3 shrink-0 max-[500px]:border-x-0">
                찜
                <span className="text-[22px] max-[700px]:text-xl pl-3 pr-1">
                  {data?.length}
                </span>
            ...
            >
              <form>
                ...
                <div className="flex flex-col gap-y-7">
                  <p className="text-lg max-[700px]:text-base font-semibold border-b border-[#ccc] pb-4">
                    기본 정보
                  </p>
              ...
              <div className="flex flex-col gap-y-2">
                <p className="text-lg font-semibold border-b border-[#ccc] pb-4 max-[700px]:text-base">
                  배송지 정보
                </p>
